...
const CATALOG: Section[] = [
	{ section: '10 Frame Items', items: [
		{ name: 'Deep Super 9 5/8', variants: [{ label: 'Unassembled', price: 14.50 }, { label: 'Assembled', price: 17.50 }] },
		{ name: 'Medium Super 6 5/8', variants: [{ label: 'Unassembled', price: 12.50 }, { label: 'Assembled', price: 15.00 }] },
		{ name: 'Shallow Super 5 5/8', variants: [{ label: 'Unassembled', price: 12.00 }, { label: 'Assembled', price: 14.50 }] },
		{ name: 'Vented Super 3"', variants: [{ label: 'Unassembled', price: 6.50 }, { label: 'Assembled', price: 9.00 }] },
		{ name: 'Telescoping Top', price: 18.00 },
		{ name: 'Migratory Top (PVC)', price: 12.00 },
		{ name: 'Inner Cover', price: 8.00 },
		{ nameTemplate: '{variant} Bottom Board', variants: [{ label: 'Solid', price: 12.00 }, { label: 'Screened', price: 12.00 }] },
		{ name: 'PVC Solid Bottom Board', price: 13.00 },
		{ name: 'F Style Screened Bottom Board', price: 17.50 },
		{ name: 'Stand (10" Legs)', price: 21.00 },
	]},
	{ section: '8 Frame Items', items: [
		{ name: 'Deep Super 9 5/8', variants: [{ label: 'Unassembled', price: 14.00 }, { label: 'Assembled', price: 17.00 }] },
		{ name: 'Medium Super 6 5/8', variants: [{ label: 'Unassembled', price: 12.00 }, { label: 'Assembled', price: 14.50 }] },
		{ name: 'Vented Super 3"', variants: [{ label: 'Unassembled', price: 6.50 }, { label: 'Assembled', price: 9.00 }] },
		{ name: 'Telescoping Top', price: 18.00 },
		{ name: 'Migratory Top (PVC)', price: 12.00 },
		{ name: 'Inner Cover', price: 8.00 },
		...
		{ name: 'Stand (10" Legs)', price: 20.00 },
	]},
	{ section: '5 Frame Items', items: [
		{ name: 'Deep Nuc', variants: [{ label: 'Unassembled', price: 11.50 }, { label: 'Assembled', price: 14.50 }] },
		{ name: 'Medium Nuc', variants: [{ label: 'Unassembled', price: 10.00 }, { label: 'Assembled', price: 13.00 }] },
		{ name: 'Telescoping Top', price: 14.50 },
		{ name: 'Migratory Top (PVC)', price: 9.50 },
		{ name: 'Inner Cover', price: 6.00 },
		{ nameTemplate: '{variant} Bottom Board', variants: [{ label: 'Solid', price: 9.50 }, { label: 'Screened', price: 9.50 }] },
		{ name: 'PVC Solid Bottom Board', price: 10.00 },
	]},
	{ section: 'Queen Rearing Supplies', items: [
		{ name: '2 Frame Mating Nuc', price: 23.00 },
		{ name: '3 Compartment Queen Castle', price: 45.00 },
	...
	{ section: 'Loaded Boxes With Frames & Acorn Heavy Wax Foundation', items: [
		{ name: '10 Frame Deep', price: 48.00 },
		{ name: '10 Frame Medium', price: 42.00 },
		{ name: '8 Frame Deep', price: 41.40 },
		{ name: '8 Frame Medium', price: 36.10 },
	]},
	{ section: 'Complete & Starter Hives', items: [
		{ name: 'Complete Hive (10 Frame, No Paint) — 2 Med Loaded, 2 Deep Loaded, Top, Inner, Bottom, Closer, Reducer', price: 210.50 },
		{ name: 'Complete Hive (8 Frame, No Paint)', price: 195.60 },
		{ name: 'Starter Hive (10 Frame, No Paint) — 1 Deep Loaded, Top, Inner, Bottom, Closer, Reducer', price: 88.00 },
		{ name: 'Starter Hive (8 Frame, No Paint)', price: 81.45 },
		{ name: 'Complete Deep Nuc — Not Loaded, Top, Inner, Bottom', price: 45.50 },
		{ name: 'Complete Medium Nuc — Not Loaded, Top, Inner, Bottom', price: 44.00 },
		{ name: 'Resource Hive', variants: [{ label: 'Unassembled', price: 66.00 }, { label: 'Assembled', price: 75.00 }] },
	]},
	{ section: 'Honey Harvesting', items: [
		...
		{ name: 'Serrated Uncapping Knife', price: 8.00 },
	]},
	{ section: 'Mite Treatments', items: [
		{ name: 'Oxalic Acid 16 ounces', price: 13.00 },
	]},
	...
	{ section: 'Bee Health', items: [
		...
		{ name: '10lb Ultra Bee Pollen Dry Substitute', price: 36.00 },
